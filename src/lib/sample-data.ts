...
const softwareEngineer: ResumeData = {
  ...
  photoUrl: 'https://placehold.co/150x150/a9d5e5/333333.png',
  description:
...
const dataAnalyst: ResumeData = {
  ...
  photoUrl: 'https://placehold.co/150x150/d4a373/333333.png',
  description:
...
const accountant: ResumeData = {
  ...
  photoUrl: 'https://placehold.co/150x150/e6b8a2/333333.png',
  description:
...
const manager: ResumeData = {
  ...
  photoUrl: 'https://placehold.co/150x150/9a8c98/333333.png',
  description:
...
const executive: ResumeData = {
  ...
  photoUrl: 'https://placehold.co/150x150/c9cba3/333333.png',
...
const financeProfessional: ResumeData = {
  ...
  photoUrl: 'https://placehold.co/150x150/f7d1cd/333333.png',
...
const civilEngineer: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/78c6a3/333333.png',
...
const teacher: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/eac4d5/333333.png',
...
const uxUiDesigner: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/83c5be/333333.png',
...
const graphicDesigner: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/f08080/333333.png',
...
const electricalEngineer: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/bde0fe/333333.png',
...
const mechanicalEngineer: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/a2d2ff/333333.png',
...
const webDeveloper: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/ffafcc/333333.png',
...
const devopsEngineer: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/fca311/333333.png',
...
const cloudEngineer: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/cdb4db/333333.png',
...
const technologyConsultant: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/14213d/ffffff.png',
...
const salesAndMarketing: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/ffc8dd/333333.png',
...
const healthcareProfessional: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/457b9d/ffffff.png',
...
const itSupportSpecialist: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/e5e5e5/333333.png',
...
const productManager: ResumeData = {
    ...
    photoUrl: 'https://placehold.co/150x150/ffddd2/333333.png',
