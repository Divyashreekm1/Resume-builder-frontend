...
import { Mail, Phone, MapPin, Briefcase, GraduationCap, Lightbulb, Award, FolderKanban, TrendingUp } from 'lucide-react';
        ...
        <div className="flex w-full h-full bg-white text-gray-800 text-xs">
            ...
            <div className="w-2/3 p-6 overflow-y-auto">
                ...
                {data.experience.length > 0 && (
                    <Section title="Sales Experience" icon={Briefcase}>
